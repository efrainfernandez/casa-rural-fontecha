    ...
    <footer className="border-t border-outline-variant bg-surface-container-low">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-between px-gutter py-12 md:flex-row md:py-16">
        <div className="mb-8 text-center md:mb-0 md:text-left">
          <div className="font-headline-md mb-2 text-headline-md tracking-tight text-secondary">
            Casa Rural Fontecha
          </div>
        ...
        <div className="flex flex-wrap justify-center gap-8 md:gap-12">
          ...
          <Link
            href="#"
            className="flex items-center gap-2 font-body-md text-body-md text-on-surface-variant transition-colors hover:text-secondary"
          >
